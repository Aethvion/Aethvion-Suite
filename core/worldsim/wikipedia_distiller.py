"""
core/worldsim/wikipedia_distiller.py
══════════════════════════════════════
Converts raw Wikipedia-style text into WorldSim Layer-1 entity files.
...
Usage
-----
    from core.worldsim.wikipedia_distiller import WikipediaDistiller
