...
async def list_bakes(
    ...
    from core.aethviondb.baker import list_bakes as _list
    bakes = _list(root)
...
async def trigger_bake(
    ...
    from core.aethviondb.baker import (
...
async def get_bake(
    ...
    from core.aethviondb.baker import read_bake_meta
...
async def delete_bake(
    ...
    from core.aethviondb.baker import delete_bake as _delete, is_baking, current_bake_name
...
async def rename_bake(
    ...
    from core.aethviondb.baker import rename_bake as _rename, safe_name
