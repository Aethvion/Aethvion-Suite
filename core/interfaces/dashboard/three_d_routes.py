    ...
    async def _generate():
        try:
            ...
            if model == "triposr":
                ...
                triposr_server = (Path(__file__).parent / 'templates' / 'triposr_server.py').read_text(encoding='utf-8')
...
"""
            ...
            server_template = (Path(__file__).parent / 'templates' / 'tsr_server_template.py').read_text(encoding='utf-8')
